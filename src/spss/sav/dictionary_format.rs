...
pub(super) const MISSING_VALUE_COUNT_MAX: usize = 3;
...
/// label bytes.
#[allow(dead_code)] // documents the layout; the reader consumes this
// field through a typed read rather than by byte length.
